...
public class ExternalScenarioWithUI extends ScenarioWithUI {

    public static final int WIDTH = 800;
    public static final int HEIGHT = 800;

    public ExternalScenarioWithUI(final ExternalScenario scenario) {
        super(
            scenario,
            List.of(
    ...
    public static void main(final String[] args) {
        final ExternalScenarioWithUI externalScenarioWithUI =
            new ExternalScenarioWithUI(new ExternalScenario());
        externalScenarioWithUI.createController();
    }
