...
# sweep directory
sweep_directory = "/home/carrknight/code/oxfish/docs/groundfish/yesgarbage/northquota_logbook/"
...
def scorer(yamlfile,output_directory):
    ...
    #fit logit to it
    # throug R
    args = ["Rscript", "/home/carrknight/code/oxfish/docs/groundfish/yesgarbage/northquota_logbook/grinder-habit-inter.R",
