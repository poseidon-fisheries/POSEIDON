...
public class AbundanceCompressedExponentialFadInitializerFactoryTest {
    ...
    private FadInitializer<AbundanceLocalBiology, AbundanceFad> generateFakeInitializer(final double fadDudRate) {
        ...
        final CompressedAbundanceFadInitializerFactory factory = yaml.loadAs(
            defaultConstructor,
            CompressedAbundanceFadInitializerFactory.class
        );
        final SpeciesCodesFromFileFactory speciesCodesFactory =
        ...
        final FishState fakeModel = mock(FishState.class, RETURNS_DEEP_STUBS);
