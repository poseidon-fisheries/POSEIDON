...
public class CurrentVectorsTest {
    ...
    public void positiveDaysOffset() {
        assertEquals(0, CurrentVectorsEPO.positiveDaysOffset(1, 1));
        assertEquals(1, CurrentVectorsEPO.positiveDaysOffset(1, 2));
        assertEquals(364, CurrentVectorsEPO.positiveDaysOffset(1, 365));
        assertEquals(1, CurrentVectorsEPO.positiveDaysOffset(365, 1));
    }

    @Test
    public void negativeDaysOffset() {
        assertEquals(0, CurrentVectorsEPO.negativeDaysOffset(1, 1));
        assertEquals(-1, CurrentVectorsEPO.negativeDaysOffset(2, 1));
        assertEquals(-364, CurrentVectorsEPO.negativeDaysOffset(365, 1));
        assertEquals(-1, CurrentVectorsEPO.negativeDaysOffset(1, 365));
    }
