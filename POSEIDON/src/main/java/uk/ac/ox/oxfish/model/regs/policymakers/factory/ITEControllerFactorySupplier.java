...
public class ITEControllerFactorySupplier
    extends BasicFactorySupplier<ITEControllerFactory> {
    public ITEControllerFactorySupplier() {
        super(ITEControllerFactory.class, "ITEControllerFactory");
    }
}
