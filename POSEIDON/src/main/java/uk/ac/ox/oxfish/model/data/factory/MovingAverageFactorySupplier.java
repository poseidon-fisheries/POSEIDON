...
public class MovingAverageFactorySupplier
    extends BasicFactorySupplier<MovingAverageFactory> {
    public MovingAverageFactorySupplier() {
        super(MovingAverageFactory.class);
    }
}
