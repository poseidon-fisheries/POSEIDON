...
public class MaximumStepsFactorySupplier
    extends BasicFactorySupplier<MaximumStepsFactory> {
    public MaximumStepsFactorySupplier() {
        super(MaximumStepsFactory.class, "Until Full With Day Limit");
    }
}
