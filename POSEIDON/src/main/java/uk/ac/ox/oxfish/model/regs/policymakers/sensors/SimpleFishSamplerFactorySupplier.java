...
public class SimpleFishSamplerFactorySupplier
    extends BasicFactorySupplier<SimpleFishSamplerFactory> {
    public SimpleFishSamplerFactorySupplier() {
        super(SimpleFishSamplerFactory.class);
    }
}
