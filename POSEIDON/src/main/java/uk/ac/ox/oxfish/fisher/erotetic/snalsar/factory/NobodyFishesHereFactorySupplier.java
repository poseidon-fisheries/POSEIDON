...
public class NobodyFishesHereFactorySupplier
    extends BasicFactorySupplier<NobodyFishesHereFactory> {
    public NobodyFishesHereFactorySupplier() {
        super(NobodyFishesHereFactory.class);
    }
}
