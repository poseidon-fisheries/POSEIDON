...
public class ITargetTACFactorySupplier
    extends BasicFactorySupplier<ITargetTACFactory> {
    public ITargetTACFactorySupplier() {
        super(ITargetTACFactory.class, "Itarget Controller");
    }
}
