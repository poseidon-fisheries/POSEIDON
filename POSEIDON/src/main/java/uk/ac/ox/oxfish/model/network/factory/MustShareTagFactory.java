 ...
 * <p>
 * nothing ---> "A" is okay nothing ---> nothing is okay "A" ----> "A" is okay "A","B" ---> "A" is
 * okay "B" ---> "A" is not okay "B" ---> nothing is not okay
 */
public class MustShareTagFactory implements AlgorithmFactory<NetworkPredicate> {
