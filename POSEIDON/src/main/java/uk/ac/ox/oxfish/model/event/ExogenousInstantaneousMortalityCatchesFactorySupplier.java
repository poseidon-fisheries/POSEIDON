...
public class ExogenousInstantaneousMortalityCatchesFactorySupplier
    extends BasicFactorySupplier<ExogenousInstantaneousMortalityCatchesFactory> {
    public ExogenousInstantaneousMortalityCatchesFactorySupplier() {
        super(
