...
public class ConstantWeatherFactorySupplier
    extends BasicFactorySupplier<ConstantWeatherFactory> {
    public ConstantWeatherFactorySupplier() {
        super(ConstantWeatherFactory.class, "Constant Weather");
    }
}
