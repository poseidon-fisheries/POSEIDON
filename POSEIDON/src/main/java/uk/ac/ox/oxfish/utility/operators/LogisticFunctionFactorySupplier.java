...
public class LogisticFunctionFactorySupplier
    extends BasicFactorySupplier<LogisticFunctionFactory> {
    public LogisticFunctionFactorySupplier() {
        super(LogisticFunctionFactory.class);
    }
}
