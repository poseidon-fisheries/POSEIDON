...
public class RBFNetworkFactorySupplier
    extends BasicFactorySupplier<RBFNetworkFactory> {
    public RBFNetworkFactorySupplier() {
        super(RBFNetworkFactory.class, "RBF Network");
    }
}
