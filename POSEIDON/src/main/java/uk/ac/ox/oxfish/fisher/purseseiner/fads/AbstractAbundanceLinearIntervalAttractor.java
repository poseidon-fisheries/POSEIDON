...
public abstract class AbstractAbundanceLinearIntervalAttractor
    ...
    public AbstractAbundanceLinearIntervalAttractor(
        final Map<Species, NonMutatingArrayFilter> globalSelectivityCurves, final FishState model,
    ...
    protected boolean shouldICancelTheAttractionToday(
        ...
        final double[] carryingCapacitiesPerSpecies = fad.getCarryingCapacity().getCarryingCapacities();
    ...
    public static HashMap<Species, double[][]> turnSelectivityIntoBiomassToAbundanceConverter(
        final FishState state, final Map<Species, NonMutatingArrayFilter> globalSelectivityCurves
    ) {
