...
public class EpsilonGreedyBanditFactorySupplier
    extends BasicFactorySupplier<EpsilonGreedyBanditFactory> {
    public EpsilonGreedyBanditFactorySupplier() {
        super(EpsilonGreedyBanditFactory.class);
    }
}
