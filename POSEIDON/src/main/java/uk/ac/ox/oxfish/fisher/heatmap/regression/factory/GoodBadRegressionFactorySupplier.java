...
public class GoodBadRegressionFactorySupplier
    extends BasicFactorySupplier<GoodBadRegressionFactory> {
    public GoodBadRegressionFactorySupplier() {
        super(GoodBadRegressionFactory.class, "Good-Bad");
    }
}
