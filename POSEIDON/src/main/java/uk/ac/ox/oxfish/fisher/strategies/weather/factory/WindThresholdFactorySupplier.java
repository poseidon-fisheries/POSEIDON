...
public class WindThresholdFactorySupplier
    extends BasicFactorySupplier<WindThresholdFactory> {
    public WindThresholdFactorySupplier() {
        super(WindThresholdFactory.class, "Sail up to Threshold");
    }
}
