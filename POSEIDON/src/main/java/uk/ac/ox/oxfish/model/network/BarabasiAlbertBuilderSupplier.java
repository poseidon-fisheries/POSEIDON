...
public class BarabasiAlbertBuilderSupplier
    extends BasicFactorySupplier<BarabasiAlbertBuilder> {
    public BarabasiAlbertBuilderSupplier() {
        super(BarabasiAlbertBuilder.class, "Barabasi-Albert");
    }
}
