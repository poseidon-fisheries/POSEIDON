...
public class RockyPyramidsFactorySupplier
    extends BasicFactorySupplier<RockyPyramidsFactory> {
    public RockyPyramidsFactorySupplier() {
        super(RockyPyramidsFactory.class);
    }
}
