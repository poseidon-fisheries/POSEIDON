...
public class DefaultToDestinationStrategyFishingStrategyFactorySupplier
    extends BasicFactorySupplier<DefaultToDestinationStrategyFishingStrategyFactory> {
    public DefaultToDestinationStrategyFishingStrategyFactorySupplier() {
        super(
