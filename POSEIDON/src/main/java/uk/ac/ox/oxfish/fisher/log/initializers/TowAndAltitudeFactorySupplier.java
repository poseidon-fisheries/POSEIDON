...
public class TowAndAltitudeFactorySupplier
    extends BasicFactorySupplier<TowAndAltitudeFactory> {
    public TowAndAltitudeFactorySupplier() {
        super(TowAndAltitudeFactory.class);
    }
}
