...
public class MustShareTagFactorySupplier
    extends BasicFactorySupplier<MustShareTagFactory> {
    public MustShareTagFactorySupplier() {
        super(MustShareTagFactory.class, "Must share a tag");
    }
}
