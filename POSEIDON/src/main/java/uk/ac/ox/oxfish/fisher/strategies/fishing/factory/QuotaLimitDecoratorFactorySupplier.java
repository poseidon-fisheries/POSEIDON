...
public class QuotaLimitDecoratorFactorySupplier
    extends BasicFactorySupplier<QuotaLimitDecoratorFactory> {
    public QuotaLimitDecoratorFactorySupplier() {
        super(QuotaLimitDecoratorFactory.class, "Quota Bound");
    }
}
