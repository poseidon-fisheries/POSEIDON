...
public class WeightLimitMarketFactorySupplier
    extends BasicFactorySupplier<WeightLimitMarketFactory> {
    public WeightLimitMarketFactorySupplier() {
        super(WeightLimitMarketFactory.class);
    }
}
