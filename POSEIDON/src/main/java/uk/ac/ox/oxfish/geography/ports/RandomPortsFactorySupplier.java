...
public class RandomPortsFactorySupplier
    extends BasicFactorySupplier<RandomPortsFactory> {
    public RandomPortsFactorySupplier() {
        super(RandomPortsFactory.class, "Random Ports");
    }
}
