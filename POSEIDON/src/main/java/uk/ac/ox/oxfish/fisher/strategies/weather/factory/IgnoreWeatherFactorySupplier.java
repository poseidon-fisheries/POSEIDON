...
public class IgnoreWeatherFactorySupplier
    extends BasicFactorySupplier<IgnoreWeatherFactory> {
    public IgnoreWeatherFactorySupplier() {
        super(IgnoreWeatherFactory.class, "Ignore Weather");
    }
}
