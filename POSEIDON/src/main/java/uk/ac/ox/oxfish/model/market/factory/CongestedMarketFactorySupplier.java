...
public class CongestedMarketFactorySupplier
    extends BasicFactorySupplier<CongestedMarketFactory> {
    public CongestedMarketFactorySupplier() {
        super(CongestedMarketFactory.class);
    }
}
