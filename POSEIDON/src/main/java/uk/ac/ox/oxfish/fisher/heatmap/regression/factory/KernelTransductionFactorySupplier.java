...
public class KernelTransductionFactorySupplier
    extends BasicFactorySupplier<KernelTransductionFactory> {
    public KernelTransductionFactorySupplier() {
        super(KernelTransductionFactory.class);
    }
}
