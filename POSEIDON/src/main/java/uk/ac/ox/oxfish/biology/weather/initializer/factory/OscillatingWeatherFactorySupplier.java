...
public class OscillatingWeatherFactorySupplier
    extends BasicFactorySupplier<OscillatingWeatherFactory> {
    public OscillatingWeatherFactorySupplier() {
        super(OscillatingWeatherFactory.class);
    }
}
