...
public class FixedGearStrategyFactorySupplier
    extends BasicFactorySupplier<FixedGearStrategyFactory> {
    public FixedGearStrategyFactorySupplier() {
        super(FixedGearStrategyFactory.class, "Never Change Gear");
    }
}
