...
public class IterativeAverageMerger implements DoubleBinaryOperator {

    private final IntSupplier numObservationsSupplier;

    public IterativeAverageMerger(final IntSupplier numObservationsSupplier) {
