...
public class CashFlowObjectiveFactorySupplier
    extends BasicFactorySupplier<CashFlowObjectiveFactory> {
    public CashFlowObjectiveFactorySupplier() {
        super(CashFlowObjectiveFactory.class);
    }
}
