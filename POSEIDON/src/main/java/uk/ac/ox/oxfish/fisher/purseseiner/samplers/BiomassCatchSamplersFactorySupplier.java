...
public class BiomassCatchSamplersFactorySupplier extends BasicFactorySupplier<BiomassCatchSamplersFactory> {
    public BiomassCatchSamplersFactorySupplier() {
        super(BiomassCatchSamplersFactory.class);
    }
}
