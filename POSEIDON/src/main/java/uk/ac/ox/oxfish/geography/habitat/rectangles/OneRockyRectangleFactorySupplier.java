...
public class OneRockyRectangleFactorySupplier
    extends BasicFactorySupplier<OneRockyRectangleFactory> {
    public OneRockyRectangleFactorySupplier() {
        super(OneRockyRectangleFactory.class);
    }
}
