...
public class IterativeAverageFactorySupplier
    extends BasicFactorySupplier<IterativeAverageFactory> {
    public IterativeAverageFactorySupplier() {
        super(IterativeAverageFactory.class, "Average");
    }
}
