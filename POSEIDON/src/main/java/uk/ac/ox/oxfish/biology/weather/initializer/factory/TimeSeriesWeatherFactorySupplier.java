...
public class TimeSeriesWeatherFactorySupplier
    extends BasicFactorySupplier<TimeSeriesWeatherFactory> {
    public TimeSeriesWeatherFactorySupplier() {
        super(TimeSeriesWeatherFactory.class, "CSV Fixed Weather");
    }
}
