...
public class MonthlyDepartingFactorySupplier
    extends BasicFactorySupplier<MonthlyDepartingFactory> {
    public MonthlyDepartingFactorySupplier() {
        super(MonthlyDepartingFactory.class);
    }
}
