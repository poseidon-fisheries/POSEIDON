...
public class FullSeasonalRetiredDataCollectorsFactorySupplier
    extends BasicFactorySupplier<FullSeasonalRetiredDataCollectorsFactory> {
    public FullSeasonalRetiredDataCollectorsFactorySupplier() {
        super(
