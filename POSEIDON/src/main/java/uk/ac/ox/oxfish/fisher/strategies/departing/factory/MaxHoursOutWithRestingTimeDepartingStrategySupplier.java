...
public class MaxHoursOutWithRestingTimeDepartingStrategySupplier
    extends BasicFactorySupplier<MaxHoursOutWithRestingTimeDepartingStrategy> {
    public MaxHoursOutWithRestingTimeDepartingStrategySupplier() {
        super(
