...
public class NPricesMarketFactorySupplier
    extends BasicFactorySupplier<NPricesMarketFactory> {
    public NPricesMarketFactorySupplier() {
        super(NPricesMarketFactory.class, "Many Prices Market");
    }
}
