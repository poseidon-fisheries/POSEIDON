...
public class LessThanXFishersHereExtractorFactorySupplier
    extends BasicFactorySupplier<LessThanXFishersHereExtractorFactory> {
    public LessThanXFishersHereExtractorFactorySupplier() {
        super(
