...
public class FixedGasFactorySupplier
    extends BasicFactorySupplier<FixedGasFactory> {
    public FixedGasFactorySupplier() {
        super(FixedGasFactory.class, "Fixed Gas Price");
    }
}
