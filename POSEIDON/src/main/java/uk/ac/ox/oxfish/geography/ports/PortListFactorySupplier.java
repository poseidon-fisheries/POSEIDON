...
public class PortListFactorySupplier
    extends BasicFactorySupplier<PortListFactory> {
    public PortListFactorySupplier() {
        super(PortListFactory.class, "List of Ports");
    }
}
