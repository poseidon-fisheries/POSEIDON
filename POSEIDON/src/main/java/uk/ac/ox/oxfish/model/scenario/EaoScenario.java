...
import uk.ac.ox.oxfish.fisher.purseseiner.regulations.DefaultEaoRegulations;
...
public abstract class EaoScenario<B extends LocalBiology>
    ...
    private InputPath inputFolder = InputPath.of("D:\\MARELA", "atl_inputs");
    ...
    private AlgorithmFactory<? extends Regulations> regulations = DefaultEaoRegulations.make(getInputFolder());
