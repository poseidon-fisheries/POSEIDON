...
public class AllSandyHabitatFactorySupplier
    extends BasicFactorySupplier<AllSandyHabitatFactory> {
    public AllSandyHabitatFactorySupplier() {
        super(AllSandyHabitatFactory.class, "All Sand");
    }
}
