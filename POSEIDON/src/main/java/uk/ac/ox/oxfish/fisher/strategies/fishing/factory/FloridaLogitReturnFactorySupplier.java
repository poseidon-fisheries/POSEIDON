...
public class FloridaLogitReturnFactorySupplier
    extends BasicFactorySupplier<FloridaLogitReturnFactory> {
    public FloridaLogitReturnFactorySupplier() {
        super(FloridaLogitReturnFactory.class, "WFS Logit Return");
    }
}
