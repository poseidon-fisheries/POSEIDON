...
public class FromLeftToRightLogisticPlusClimateChangeFactorySupplier
    extends BasicFactorySupplier<FromLeftToRightLogisticPlusClimateChangeFactory> {
    public FromLeftToRightLogisticPlusClimateChangeFactorySupplier() {
        super(
