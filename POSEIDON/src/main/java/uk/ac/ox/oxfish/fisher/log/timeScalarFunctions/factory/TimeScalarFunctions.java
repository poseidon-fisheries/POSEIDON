...
public class TimeScalarFunctions {
    ...
    static{
        CONSTRUCTORS.put("Inverse",
                         InverseTimeScalarFactory::new);
        NAMES.put(InverseTimeScalarFactory.class,
                  "Inverse");

        CONSTRUCTORS.put("Exponential",
        		ExponentialTimeScalarFactory::new);
        NAMES.put(ExponentialTimeScalarFactory.class,
                  "Exponential");


        CONSTRUCTORS.put("Sigmoidal",
        		SigmoidalTimeScalarFactory::new);
        NAMES.put(SigmoidalTimeScalarFactory.class,
                  "Sigmoidal");
    }
