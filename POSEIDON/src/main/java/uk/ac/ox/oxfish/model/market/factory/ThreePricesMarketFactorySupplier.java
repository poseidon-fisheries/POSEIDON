...
public class ThreePricesMarketFactorySupplier
    extends BasicFactorySupplier<ThreePricesMarketFactory> {
    public ThreePricesMarketFactorySupplier() {
        super(ThreePricesMarketFactory.class);
    }
}
