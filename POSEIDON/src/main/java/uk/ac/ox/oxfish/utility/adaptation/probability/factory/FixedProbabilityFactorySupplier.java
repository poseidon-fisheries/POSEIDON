...
public class FixedProbabilityFactorySupplier
    extends BasicFactorySupplier<FixedProbabilityFactory> {
    public FixedProbabilityFactorySupplier() {
        super(FixedProbabilityFactory.class, "Fixed Probability");
    }
}
