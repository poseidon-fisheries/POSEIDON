...
public class BuildSampleInputs {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        sortedFolders.sort((o1, o2) -> String.CASE_INSENSITIVE_ORDER.compare(
        ...
        final ObjectOutput objectStream = new ObjectOutputStream(
            Files.newOutputStream(directory.resolve("premade.data").toFile().toPath())
        );
