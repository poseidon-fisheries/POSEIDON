...
public class NoDiscardingFactorySupplier
    extends BasicFactorySupplier<NoDiscardingFactory> {
    public NoDiscardingFactorySupplier() {
        super(NoDiscardingFactory.class);
    }
}
