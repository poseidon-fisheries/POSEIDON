...
public class DiscardUnderagedFactorySupplier
    extends BasicFactorySupplier<DiscardUnderagedFactory> {
    public DiscardUnderagedFactorySupplier() {
        super(DiscardUnderagedFactory.class, "Age Discarding");
    }
}
