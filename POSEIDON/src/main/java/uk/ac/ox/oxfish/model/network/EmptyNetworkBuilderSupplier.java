...
public class EmptyNetworkBuilderSupplier
    extends BasicFactorySupplier<EmptyNetworkBuilder> {
    public EmptyNetworkBuilderSupplier() {
        super(EmptyNetworkBuilder.class, "No Network");
    }
}
