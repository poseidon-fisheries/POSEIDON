...
public class SurplusProductionDepletionFormulaControllerSupplier
    extends BasicFactorySupplier<SurplusProductionDepletionFormulaController> {
    public SurplusProductionDepletionFormulaControllerSupplier() {
        super(
