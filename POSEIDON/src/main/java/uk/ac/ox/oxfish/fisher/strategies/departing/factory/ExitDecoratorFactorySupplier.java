...
public class ExitDecoratorFactorySupplier
    extends BasicFactorySupplier<ExitDecoratorFactory> {
    public ExitDecoratorFactorySupplier() {
        super(ExitDecoratorFactory.class);
    }
}
