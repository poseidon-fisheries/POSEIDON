...
public class FishUntilFullFactorySupplier
    extends BasicFactorySupplier<FishUntilFullFactory> {
    public FishUntilFullFactorySupplier() {
        super(FishUntilFullFactory.class);
    }
}
