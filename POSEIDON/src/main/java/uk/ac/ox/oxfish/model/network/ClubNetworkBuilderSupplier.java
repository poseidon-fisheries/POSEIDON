...
public class ClubNetworkBuilderSupplier
    extends BasicFactorySupplier<ClubNetworkBuilder> {
    public ClubNetworkBuilderSupplier() {
        super(ClubNetworkBuilder.class, "Same Size Clubs");
    }
}
