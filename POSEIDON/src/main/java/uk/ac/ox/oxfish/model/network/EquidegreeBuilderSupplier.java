...
public class EquidegreeBuilderSupplier
    extends BasicFactorySupplier<EquidegreeBuilder> {
    public EquidegreeBuilderSupplier() {
        super(EquidegreeBuilder.class, "Equal Out Degree");
    }
}
