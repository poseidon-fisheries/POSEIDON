...
# sweep directory
sweep_directory = "/home/carrknight/code/oxfish/docs/groundfish/yesgarbage/noonetrip/"
...
def scorer(yamlfile,output_directory):
    ...
    #fit logit to it
    # throug R
    args = ["Rscript", "/home/carrknight/code/oxfish/docs/groundfish/yesgarbage/noonetrip/logbook/grinder-habit-inter.R",
