...
public abstract class DestinationBehaviour implements Behaviour {
    ...
    public Action newAction(
        ...
        travelBehaviour.setCurrentDestination(chooseDestination(vessel));
        return travelBehaviour.newAction(dateTime, vessel);
    }

    protected abstract Int2D chooseDestination(Vessel vessel);
}
