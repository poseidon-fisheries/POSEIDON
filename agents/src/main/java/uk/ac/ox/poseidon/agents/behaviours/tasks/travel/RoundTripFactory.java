...
package uk.ac.ox.poseidon.agents.behaviours.tasks.travel;
...
@NoArgsConstructor
@AllArgsConstructor
public class RoundTripFactory extends VesselScopeFactory<Sequence<Vessel>> {

    private Factory<? extends TravelTask> travelTask;
    private Factory<? extends Task<Vessel>> taskAtDestination;

    @SuppressWarnings("unchecked")
    @Override
    protected Sequence<Vessel> newInstance(
