...
/**
 * A {@link Predicate} that is true iff the tested date is strictly before a supplied reference
 * date. Built via {@link Factories#dateIsBefore(uk.ac.ox.poseidon.core.Factory)} in this package.
 */
@Getter
