 ...
 * {@link Factories#durationUntil(Factory)}.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class DurationUntilProviderFactory extends SimulationScopeFactory<DurationUntilProvider> {

    private Factory<? super SimulationScope, ? extends Supplier<LocalDateTime>> referenceDateTime;

    @Override
    protected DurationUntilProvider newInstance(final SimulationScope scope) {
        return new DurationUntilProvider(
