 ...
 * {@link Factories#currentYear()}.
 */
@EqualsAndHashCode(callSuper = true)
public class CurrentYearProviderFactory extends SimulationScopeFactory<CurrentYearProvider> {
    @Override
    protected CurrentYearProvider newInstance(final SimulationScope scope) {
        return new CurrentYearProvider(scope.getSimulation().getTemporalSchedule());
    }
}
