...
public class ConstantDurationSuppliers {
    public static final Factory<Scope, Supplier<Duration>> ONE_DAY_DURATION_SUPPLIER =
        new ConstantSupplierFactory<>(new DurationFactory(1, 0, 0, 0));
    public static final Factory<Scope, Supplier<Duration>> ONE_HOUR_DURATION_SUPPLIER =
        new ConstantSupplierFactory<>(new DurationFactory(1, 0, 0, 0));
    public static final Factory<Scope, Supplier<Duration>> ONE_MINUTE_DURATION_SUPPLIER =
        new ConstantSupplierFactory<>(new DurationFactory(0, 0, 1, 0));
    public static final Factory<Scope, Supplier<Duration>> ONE_SECOND_DURATION_SUPPLIER =
