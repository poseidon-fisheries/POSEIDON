...
public class ExhaustiveAcquisitionFunctionTest {
    ...
    public void finds2525() throws Exception {
        ...
        when(regression.predict(any(SeaTile.class), eq(120d))).thenAnswer((Answer<Double>) invocation -> {
        ...
        SeaTile pick = acquisitionFunction.pick(state.getMap(), regression, state);
