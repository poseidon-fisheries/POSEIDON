...
public class MultipleSpeciesAbundanceInitializerTest
{
    ...
    public void allInOne() throws Exception {
        ...
        assertEquals(0,map.getSeaTile(2,3).getNumberOfMaleFishPerAge(fakeSpecies)[0]);
        assertEquals(0,map.getSeaTile(2,3).getNumberOfFemaleFishPerAge(fakeSpecies)[1]);
        assertEquals(0,map.getSeaTile(2,3).getNumberOfFemaleFishPerAge(fakeSpecies)[1]);
    }
