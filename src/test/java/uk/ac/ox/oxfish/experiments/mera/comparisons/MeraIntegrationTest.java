...
public class MeraIntegrationTest {
    ...
    public void scenarioLandsRight() throws IOException {
        ...
        Path scenarioPath = Paths.get("inputs","tests","mera_integration","slice3_scenario_1.yaml");
        DoubleSummaryStatistics averageLandings = new DoubleSummaryStatistics();
        for (int i = 0; i < 5; i++) {
            FishState run = FishStateUtilities.run("test", scenarioPath,
                                                   null,
                                                   System.currentTimeMillis(),
                                                   0, false, null, 1, false, -1,
                                                   null, null, null, null);
        ...
        double errorRate = Math.abs(1.018056e+07 - averageLandings.getAverage()) / 1.018056e+07;
