...
public class MultipleRegulationsTest {
    ...
    public void simpleChecks() throws Exception {
        ...
        regs.reactToFishing(tile, who, haul, 10);
        verify(mpa).reactToFishing(tile,who,haul,10);
        verify(season).reactToFishing(tile,who,haul,10);
        verify(quota).reactToFishing(tile,who,haul,10);
        //react to sale
