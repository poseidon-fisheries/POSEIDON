...
public class HalfBycatchInitializer implements BiologyInitializer {
    ...
    public HalfBycatchInitializer(DoubleParameter carryingCapacity, DoubleParameter steepness, double percentageLimitOnDailyMovement,
                                  double differentialPercentageToMove) {
        delegate = new DiffusingLogisticInitializer(carryingCapacity, steepness, percentageLimitOnDailyMovement, differentialPercentageToMove);
    }
