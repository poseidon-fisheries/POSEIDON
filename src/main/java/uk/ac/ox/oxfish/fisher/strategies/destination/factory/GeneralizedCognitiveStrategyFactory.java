 ...
 */
public class GeneralizedCognitiveStrategyFactory implements
        AlgorithmFactory<GeneralizedCognitiveStrategy> {

	@Override
	public GeneralizedCognitiveStrategy apply(FishState t) {
