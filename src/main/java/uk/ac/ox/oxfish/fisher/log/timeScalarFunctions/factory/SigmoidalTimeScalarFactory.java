...
public class SigmoidalTimeScalarFactory  implements AlgorithmFactory<SigmoidalTimeScalar>{
	...
	@Override
	public SigmoidalTimeScalar apply(FishState state) {
		return new SigmoidalTimeScalar(a.apply(state.random),b.apply(state.random));
	}
	...
	public void setA(DoubleParameter a){
		this.a = a;
	}
	...
	public void setB(DoubleParameter b){
		this.b = b;
	}
