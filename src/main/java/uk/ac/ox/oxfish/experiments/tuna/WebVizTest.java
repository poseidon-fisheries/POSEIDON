...
import uk.ac.ox.oxfish.model.data.webviz.heatmaps.BiomassHeatmapBuilderFactory;
...
public final class WebVizTest {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        jsonOutputManagerFactory.setHeatmapBuilderFactories(
            speciesNames.stream().map(BiomassHeatmapBuilderFactory::newInstance).collect(toImmutableList())
        );
