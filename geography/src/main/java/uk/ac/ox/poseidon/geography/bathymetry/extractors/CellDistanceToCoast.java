...
import uk.ac.ox.poseidon.core.extractors.CachedExtractor;
import uk.ac.ox.poseidon.geography.bathymetry.BathymetricGrid;
import uk.ac.ox.poseidon.geography.distance.DistanceCalculator;

@RequiredArgsConstructor
public class CellDistanceToCoast extends CachedExtractor<Int2D, Double> {

    private final BathymetricGrid bathymetricGrid;
    private final DistanceCalculator distanceCalculator;

    public Double extract(final Int2D cell) {
