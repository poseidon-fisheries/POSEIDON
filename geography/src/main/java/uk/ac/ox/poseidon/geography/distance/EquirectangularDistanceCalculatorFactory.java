...
/**
 * A {@link RelativeScopeFactory} counterpart of {@link EquirectangularDistanceCalculator}, built
 * via {@link Factories#equirectangularDistanceCalculator(Factory)}.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class EquirectangularDistanceCalculatorFactory<S extends Scope>
    extends RelativeScopeFactory<S, EquirectangularDistanceCalculator> {
