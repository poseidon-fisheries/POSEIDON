...
public class EpoGravityAbundanceScenarioSupplier extends BasicScenarioSupplier {
    public EpoGravityAbundanceScenarioSupplier() {
        super(
            EpoGravityAbundanceScenario.class,
            "EPO Abundance",
