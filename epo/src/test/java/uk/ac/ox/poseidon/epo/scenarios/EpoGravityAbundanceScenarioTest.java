...
public class EpoGravityAbundanceScenarioTest {
    ...
    /**
     * We need to make sure that all non-zero biomass grid cells in all our allocation grids match an actual SeaTile
     * with the right biology (BiomassLocalBiology or AbundanceLocalBiology) Otherwise, even if the grid's values sum up
     * to 1.0, some biomass will be lost during the reallocation process.
     */
    @Test
